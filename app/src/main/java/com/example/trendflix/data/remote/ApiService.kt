package com.example.trendflix.data.remote

import com.example.trendflix.data.remote.response.FilmResponse
import retrofit2.http.GET
import retrofit2.http.Query
import com.example.trendflix.BuildConfig
...
import com.example.trendflix.data.remote.response.MultiSearchResponse
import com.example.trendflix.data.remote.response.ReviewsResponse
...
interface ApiService {
    ...
    @GET("discover/movie?")
    suspend fun getBackInTheDaysMovie(
        @Query("page") page: Int =0,
